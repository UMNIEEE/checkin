<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="IEEECheckin.ASP.Account.Manage" %>
<%@ Register Src="~/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>

<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <h1 class="post-header">Manage Account</h1>
    <p class="section-header">Change Password <i class="fa fa-certificate"></i></p> 
        ...
        <section id="passwordForm">
            ...
            <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                ...
                <fieldset>
                    ...
                    <asp:Button class="form-control input-lg btn btn-info check-in" runat="server" Text="Set Password" ValidationGroup="SetPassword" OnClick="setPassword_Click" />
                </fieldset>
            </asp:PlaceHolder>
                ...
                <asp:ChangePassword runat="server" CancelDestinationPageUrl="~/" ViewStateMode="Disabled" RenderOuterTable="false" SuccessPageUrl="Manage?m=ChangePwdSuccess">
                    <ChangePasswordTemplate>
                        ...
                        <fieldset class="changePassword">
                            ...
                            <asp:Button class="form-control input-lg btn btn-info check-in" runat="server" CommandName="ChangePassword" Text="Change password" ValidationGroup="ChangePassword" />
                        </fieldset>
                    </ChangePasswordTemplate>
                </asp:ChangePassword>
            </asp:PlaceHolder>
    ...
    <p class="section-header">External Login <i class="fa fa-key"></i></p> 
    <div class="boxed-section margin-lg-after"> 
        <section id="externalLoginsForm">
            ...
            <asp:ListView runat="server"
                ...
                <LayoutTemplate>
                    <p class="section-label">Registered external logins</p>
                    <table>
            ...
            <p class="section-label">Add external login</p>
